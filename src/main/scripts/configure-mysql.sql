...
# wildcard, from any host. if running mysql from docker
...
# wildcard, from any host. if running mysql from docker
GRANT SELECT ON recipe_dev.* to 'sfg_dev_user'@'%';
GRANT INSERT ON recipe_dev.* to 'sfg_dev_user'@'%';
GRANT DELETE ON recipe_dev.* to 'sfg_dev_user'@'%';
GRANT UPDATE ON recipe_dev.* to 'sfg_dev_user'@'%';
GRANT SELECT ON recipe_prod.* to 'sfg_prod_user'@'%';
GRANT INSERT ON recipe_prod.* to 'sfg_prod_user'@'%';
GRANT DELETE ON recipe_prod.* to 'sfg_prod_user'@'%';
GRANT UPDATE ON recipe_prod.* to 'sfg_prod_user'@'%';